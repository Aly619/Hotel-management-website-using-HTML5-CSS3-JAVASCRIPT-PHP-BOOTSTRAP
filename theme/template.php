...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <div class="logo">
        <a href="#">
          <img width="300px" height="200px" class="logo_1" src="<?php echo WEB_ROOT;?>images/logo1.png" alt="">
           <h4 style="font-weight: bold; text-align: center; transform: translateY(6px); margin-top: -30px; color: #FF9000; font-size: 15px;">Your comfort is our priority</h4>
        <img class="logo_2" src="<?php echo WEB_ROOT;?>images/logo1.png" alt="">
        <img class="logo_3" src="<?php echo WEB_ROOT;?>images/logo1.png" alt=""></a>
      </div>
...
<!--         <div class="search_button">
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/logo1.png" alt="logo1"></a></div>
    </div>
  </div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Book your desired room</h1></div>
      <div class="home_text text-center">Book your room in easy way, fast, secure and from all with your own interest where you feel comfort.
Your comfort and security is our top priority.
  ...
  <div class="booking">
    <div class="container">
      <div class="row">
        <div style="padding-top: 40px;" class="col">
          <div style="background: #FFE3C2; height:150px;" class="booking_container d-flex flex-row align-items-center justify-content-center"> 
...
<div style="padding-top: 100px;" class="rooms">
  <div class="container">
    <?php 
     check_message();
      ...
      <div class="row">
        <div class="col">
          <div class="footer_logo text-center">
            <a href="#"><img width="250px" height="150px" src="images/logo2.png" alt="BETHAK.COM"></a>
          </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script>Designed<i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="http://mirahsanabbas@gmail.com/" target="_blank">©AHSAN AND SADIQ</a>
</div>
        </div>
      </div>
    </div>
