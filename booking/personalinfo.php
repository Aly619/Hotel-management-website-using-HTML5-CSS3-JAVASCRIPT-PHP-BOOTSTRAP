...
?>
		...
		<form style="color: black;" class="form-horizontal" action="personalinfo.php" method="post"  name="personal" >    
					  ...
					  <div class="form-group">
			           ...
			           <div class="form-group">
			            <div class="col-md-12">
			              <label style="width: 400px;" class="col-md-4 control-label" for=
			              "nationality">CNIC.NO/PASSPORT.NO:</label>
