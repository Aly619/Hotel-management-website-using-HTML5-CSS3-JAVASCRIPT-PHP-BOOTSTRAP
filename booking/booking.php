...
?>
  ...
  <div id="accom-title"  > 
    <div  class="pagetitle">   
          ...
          <table style="color: black;" class="table" id="table">
                    ...
                    $query = "SELECT * FROM `tblroom` r ,`tblaccomodation` a WHERE r.`ACCOMID`=a.`ACCOMID` AND ROOMID=" . $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomid'];
                     ...
                     $cur = $mydb->loadResultList(); 
                      foreach ($cur as $result) { 
                        ...
                        echo '</td>';
                        echo '<td>RS:<output id="TotAmount'.$_SESSION['dragonhouse_cart'][$i]['dragonhouseroomid'].'" >'.$_SESSION['dragonhouse_cart'][$i]['dragonhouseroomprice'].'</output></td>';
