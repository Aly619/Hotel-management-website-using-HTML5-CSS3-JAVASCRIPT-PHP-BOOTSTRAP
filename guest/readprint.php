...
<title><?php echo isset($title) ? $title . ' | bethak gilgit' :  'bethak gilgit' ; ?></title>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Bethak Gilgit
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>Gilgit </strong><br>
            Bethak<br>
            Nomal Gilgit<br>
            Phone: 05811424242<br>
            Email: bethakgilgit@gmail.com
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
